...
class ImageGallery:
    ...
    @classmethod
    def get_software_update_available_icon(
        cls, size: tuple[int:int] = (32, 32)
    ) -> ImageTk.PhotoImage:
    ...
    @classmethod
    def get_wireless_network_in_color_icon(
        cls, size: tuple[int:int] = (32, 32)
    ) -> ImageTk.PhotoImage:
        return ImageGallery.get_image("wireless-network-colored.png", size)

    @classmethod
    def get_wireless_network_icon(
        cls, size: tuple[int:int] = (32, 32)
    ) -> ImageTk.PhotoImage:
