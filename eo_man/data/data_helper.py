...
EEP_MAPPING = [
    # gateways and bus connectors
    {
        ...
        CONF_EEP: "unknown",
        CONF_TYPE: "unknown",
        "description": "unknown bus device",
    },
    {
        "hw-type": "FAM14",
        "brand": "Eltako",
        "description": "Bus Gateway",
        "device_type": GatewayDeviceType.EltakoFAM14.value,
        "docs": "https://github.com/grimmpp/home-assistant-eltako/tree/main/docs/gateways",
    },
    {
        "hw-type": "FGW14_USB",
        "brand": "Eltako",
        "description": "Bus Gateway",
        "device_type": GatewayDeviceType.EltakoFGW14USB.value,
        "docs": "https://github.com/grimmpp/home-assistant-eltako/tree/main/docs/gateways",
    },
    {
        "hw-type": "FTD14",
        "brand": "Eltako",
        "description": "Bus Gateway",
        "device_type": GatewayDeviceType.EltakoFTD14.value,
        "docs": "https://github.com/grimmpp/home-assistant-eltako/tree/main/docs/gateways",
    },
    {"hw-type": "FGW14", "brand": "Eltako", "description": "Bus Gateway"},
    {
        "hw-type": "FAM-USB",
        "brand": "Eltako",
        "description": "USB Gateway",
        "device_type": GatewayDeviceType.EltakoFAMUSB.value,
        "docs": "https://github.com/grimmpp/home-assistant-eltako/tree/main/docs/gateways",
    },
    {
        "hw-type": "USB300",
        "brand": "unknown",
        "description": "USB Gateway",
        "device_type": GatewayDeviceType.USB300.value,
        "docs": "https://github.com/grimmpp/home-assistant-eltako/tree/main/docs/gateways",
    },
    {
        "hw-type": "MGW (LAN)",
        "brand": "PioTek",
        "description": "USB Gateway",
        "device_type": GatewayDeviceType.LAN.value,
        "docs": "https://github.com/grimmpp/home-assistant-eltako/tree/main/docs/gateways",
    },
    {
        "hw-type": "MGW (USB)",
        "brand": "PioTek",
        "description": "USB Gateway",
        "device_type": GatewayDeviceType.ESP3.value,
        "docs": "https://github.com/grimmpp/home-assistant-eltako/tree/main/docs/gateways",
    },
    # Input module
    {
        ...
        "description": "Wired Rocker switch",
        "address_count": 1,
    },
    {
        "hw-type": "FTS14EM",
    ...
    # Wireless 4-way pushbutton
    {
        ...
        CONF_EEP: "F6-02-01",
        CONF_TYPE: Platform.BINARY_SENSOR,
        "description": "Wireless 4-way pushbutton",
        "address_count": 1,
    },
    {
        "hw-type": "F4T55E",
        ...
        CONF_EEP: "F6-02-01",
        CONF_TYPE: Platform.BINARY_SENSOR,
        "description": "Wireless 4-way pushbutton in E-Design55",
        "address_count": 1,
    },
    # window and door contacts
    {
        ...
        CONF_EEP: "F6-10-00",
        CONF_TYPE: Platform.BINARY_SENSOR,
        "description": "window and door contacts",
        "address_count": 1,
    },
    {
        "hw-type": "FTKE",
    ...
    {
        "hw-type": "FSVA-230V-10A-Power-Meter",
        "brand": "Eltako",
        CONF_EEP: "A5-12-01",
        CONF_TYPE: Platform.SENSOR,
        CONF_METER_TARIFFS: "[]",
    ...
    # Weather Station
    {
        ...
        CONF_EEP: "A5-13-01",
        CONF_TYPE: Platform.SENSOR,
        "description": "Weather Station Gateway",
        "address_count": 1,
    },
    {
        "hw-type": "MS",
    ...
    # light sensor
    {
        ...
        CONF_EEP: "A5-06-01",
        CONF_TYPE: Platform.SENSOR,
        "description": "Light - Twilight and daylight Sensor",
        "address_count": 1,
    },
    # occupancy sensor
    {
        ...
        CONF_EEP: "A5-08-01",
        CONF_TYPE: Platform.SENSOR,
        "description": "Light-, Temperature-, Occupancy Sensor",
        "address_count": 1,
    },
    {
        "hw-type": "FBH65",
    ...
    # air quality
    {
        ...
        CONF_EEP: "A5-09-0C",
        CONF_TYPE: Platform.SENSOR,
        "description": "Air Quality, Temperature and Humidity Sensor",
        "address_count": 1,
    },
    # Temp Controller
    {
        ...
        CONF_EEP: "A5-10-06",
        CONF_TYPE: Platform.SENSOR,
        "description": "Temperature Sensor and Controller",
        "address_count": 1,
    },
    {
        "hw-type": "FUTH-feature",
        "brand": "Eltako",
        CONF_EEP: "A5-10-12",
        CONF_TYPE: Platform.SENSOR,
        "description": "Temperature Sensor and Controller and Humidity Sensor",
        "address_count": 1,
    },
    # light dimmer
    {
        ...
        "PCT14-function-group": 3,
        "PCT14-key-function": 32,
    ...
    # Dali Gateway
    {
        ...
        "sender_eep": "A5-38-08",
        CONF_TYPE: Platform.LIGHT,
        "PCT14-function-group": 1,
        "PCT14-key-function": 32,
        "description": "Dali Gateway",
        "address_count": 16,
    },
    {
        "hw-type": "FD2G14",
    ...
    },
    {
        ...
        "sender_eep": "A5-38-08",
        CONF_TYPE: Platform.LIGHT,
        "PCT14-function-group": 2,
        "PCT14-key-function": 51,
        "description": "Relay",
        "address_count": 1,
    },
    {
    ...
    },
    {
        ...
        "sender_eep": "A5-38-08",
        CONF_TYPE: Platform.LIGHT,
        "description": "Socket Switch Actuator",
        "address_count": 1,
    },
    {
        "hw-type": "FSVA-230V-10A",
        "brand": "Eltako",
        CONF_EEP: "M5-38-08",
        "sender_eep": "A5-38-08",
        CONF_TYPE: Platform.LIGHT,
...
def get_all_eep_names():
    ...
    return sorted(
        set(
            [
                s.__name__.replace("_", "-").upper()
                for s in subclasses
                if len(s.__name__) == 8 and s.__name__.count("_") == 2
            ]
        )
    )
...
def find_eep_by_name(eep_name: str) -> EEP:
    for child in EEP.__subclasses__():
        if (
            child.__name__.replace("_", "-").upper()
            == eep_name.replace("_", "-").upper()
        ):
            return child
        for sub_child in child.__subclasses__():
            if (
                sub_child.eep_string.replace("_", "-").upper()
                == eep_name.replace("_", "-").upper()
            ):
                return sub_child
    return None
...
def get_values_for_eep(eep: EEP, message: EltakoMessage) -> list[str]:
    ...
    for k, v in eep.decode_message(message).__dict__.items():
        properties_as_str.append(
            f"{str(k)[1:] if str(k).startswith('_') else str(k)}: {str(v)}"
        )
...
class BusObjectHelper:
    @classmethod
    def find_sensors(
        cls, sensors: list[SensorInfo], dev_id: int, channel: int, in_func_group: int
    ) -> list[SensorInfo]:
        result = []
        for s in sensors:
            if (
...
def print_memory_entires(sensors: list[SensorInfo]) -> None:
    for _s in sensors:
        s: SensorInfo = _s
        print(
            f"{s.memory_line}: {b2s(s.sensor_id, ' ')} {hex(s.key)} {hex(s.key_func)} {hex(s.channel)} (FG: {s.in_func_group})"
        )
...
def get_all_device_classes(cls=BusObject):
    ...
    for subclass in subclasses:
        subclasses.extend(
            get_all_device_classes(subclass)
...
def find_device_class_by_name(name: str) -> BusObject:
    for dc in get_all_device_classes():
        if build_unique_name_for_device_type(
            dc.__name__
        ) == build_unique_name_for_device_type(name):
            return dc
    return None
