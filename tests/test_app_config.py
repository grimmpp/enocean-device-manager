...
class TestLoadAndStoreAppConfig(unittest.TestCase):
    def test_load(self):
        ...
        filename = os.path.join(
            os.path.dirname(__file__), "resources", "test_app_config_1.eodm"
        )
    ...
    def test_load_save_load(self):
        ...
        filename2 = os.path.join(
            os.path.dirname(__file__), "resources", "test_app_config_1_temp.eodm"
        )
        ...
        filename3 = os.path.join(
            os.path.dirname(__file__), "resources", "test_app_config_1_temp2.eodm"
        )
        ...
        self.assertEqual(
            len(app_data.selected_data_filter_name),
            len(app_data2.selected_data_filter_name),
        )
        ...
        self.assertEqual(
            len(app_data2.selected_data_filter_name),
            len(app_data3.selected_data_filter_name),
        )
        self.assertEqual(
            len(app_data2.application_version), len(app_data3.application_version)
        )
